...
- `arach-kernel` release 28 pins Arach Kernel
  `51d123b8e0902f06e71e29078eba264463e8ce13` and Push
  ...
  transfer, peer identity, half-close, poll/epoll readiness, and measured
  QEMU/OVMF evidence.
